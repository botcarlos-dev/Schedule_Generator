// Models/HorariosPessoaisViewModel.cs
using System;
...
{
    /// <summary>
    /// ViewModel utilizado para representar e organizar os horários pessoais do utilizador.
    /// </summary>
    public class HorariosPessoaisViewModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Dicionário que organiza os horários pessoais por dias da semana e períodos.
        /// </summary>
        public Dictionary<string, Dictionary<string, HORARIO_REFERENCIAL>> HorariosPessoais { get; set; }

        /// <summary>
        /// Construtor da classe <see cref="HorariosPessoaisViewModel"/>.
        /// Inicializa as listas de dias da semana, períodos e organiza a estrutura dos horários pessoais.
        /// </summary>
        public HorariosPessoaisViewModel()
        {
            ...
            HorariosPessoais = InicializarHorarios();
        }
        ...
        /// <summary>
        /// Inicializa a estrutura dos horários pessoais, organizando os dias da semana e períodos horários.
        /// </summary>
        /// <returns>
